...
**Note:** to enable 'non-os' scanning, the engine must be configured to sync the 'nvd' data feed - see [Initial Configuration]({{< ref "/docs/installation/configuration/configuring_engine" >}}) and [Feeds]({{< ref "/docs/installation/feeds" >}}) for details.
