...
+ New APIs for granular control of data feeds, including enable/disable toggles and data flush capabilities.
  ...
  For more information see [CLI Usage - Feeds]({{< ref "/docs/using/cli_usage/feeds/feed_configuration.md" >}})
...
NOTE: Restoring RHSA-based matching is possible, but not recommended. See the [Reverting Back to RHSA Data]({{< ref "/docs/releasenotes/engine/0.7.0/data_matching_rollback">}})
